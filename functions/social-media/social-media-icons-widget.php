...
class Social_Icons_Widget extends WP_Widget {
	...
	function register_admin_styles() {
		wp_enqueue_style('social-icons-widget-admin', get_template_directory_uri().'/functions/social-media/css/social_icons_admin.css');
	}

	function register_widget_styles() {
		wp_enqueue_style('social-icons-widget-widget', get_template_directory_uri().'/functions/social-media/css/social_icons_widget.css');
	}
