...
if ( ! function_exists( 'pg_post_meta' ) ) {

	function pg_post_meta() {
		...
		<ul class="post-meta clr">
			...
			<?php if(isset($fist_category)){ ?>
				<li class="meta-category">
					<span class="meta-seperator">/</span><?php _e('Under','pg'); ?>
					<a href="<?php echo $category_url; ?>" title="<?php echo $category_name; ?>"><?php echo $category_name; ?></a>
				</li>
			<?php } ?>
			<?php if( comments_open( $post_id ) ) { ?>
				<li class="meta-comments comment-scroll">
					<span class="meta-seperator">/</span><?php _e('With','pg'); ?>
					<?php comments_popup_link( __( '0 Comments', 'pg' ), __( '1 Comment',  'pg' ), __( '% Comments', 'pg' ), 'comments-link' ); ?>
				</li>
			<?php } ?>
		</ul><!-- .post-meta -->
